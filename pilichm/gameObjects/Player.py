from pilichm.gameObjects.Constants import ALLOWED_TERRAIN, SPRITE_HEART_BONUS_FILE, SPRITE_GRASS_FILE, \
    SPRITE_SWORD_BONUS_FILE, SPRITE_PLAYER_ARMED_RIGHT_FILE, SPRITE_PLAYER_ARMED_LEFT_FILE, \
    SPRITE_PLAYER_ARMED_UP_FILE, SPRITE_PLAYER_ARMED_DOWN_FILE, SPRITE_PLAYER_UNARMED_RIGHT_FILE, \
    SPRITE_PLAYER_UNARMED_LEFT_FILE, SPRITE_PLAYER_UNARMED_UP_FILE, SPRITE_PLAYER_UNARMED_DONW_FILE
